...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      assets: {
        src: [
          ...
          'docs/assets/js/social-feeds/rss/*.js',
        ...
        files: [
          {
            ...
            src: [
              ...
              'docs/assets/js/social-feeds/rss/jobteaser-rss.js',
    ...
    less: {
      ...
      cookiepopup: {
        src: 'less/ku-privacypolicy.less',
        dest: 'dist/css/ku-cookiepopup.css'
      },
    ...
    autoprefixer: {
      ...
      cookiepopup: {
        src: ['dist/css/ku-cookiepopup.css']
      },
      doctypes: {
        expand: true,
    ...
    cssmin: {
      ...
      cookiepopup: {
        src: 'dist/css/ku-cookiepopup.css',
        dest: 'dist/css/ku-cookiepopup.min.css'
      },
      minifyFAK: {
        expand: true,
        cwd: 'dist/css/faculties/',
  ...
  grunt.registerTask('test-js', ['jshint:core', 'jshint:grunt']);
