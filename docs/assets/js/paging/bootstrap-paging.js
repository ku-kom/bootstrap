        ...
        switch (pageType) {
          case 'page':
            if ($this.data('page') === pages.currentPage) {
              ...
              // KU
              $this.find('.' + _this.options.anchorClass).attr('aria-current', true);
            }
            break;
          case 'first':
            $this.toggleClass(_this.options.disabledClass, pages.currentPage === 1);
            // KU
            $this.find('.' + _this.options.anchorClass).attr('disabled', pages.currentPage === 1);
            break;
          case 'last':
            $this.toggleClass(_this.options.disabledClass, pages.currentPage === _this.options.totalPages);
            // KU
            $this.find('.' + _this.options.anchorClass).attr('disabled', pages.currentPage === _this.options.totalPages);
            break;
          case 'prev':
            $this.toggleClass(_this.options.disabledClass, !_this.options.loop && pages.currentPage === 1);
            // KU
            $this.find('.' + _this.options.anchorClass).attr('disabled', !_this.options.loop && pages.currentPage === 1);
            break;
          case 'next':
            $this.toggleClass(_this.options.disabledClass,  !_this.options.loop && pages.currentPage === _this.options.totalPages);
            // KU
            $this.find('.' + _this.options.anchorClass).attr('disabled', !_this.options.loop && pages.currentPage === _this.options.totalPages);
            break;
          default:
            break;
        }
